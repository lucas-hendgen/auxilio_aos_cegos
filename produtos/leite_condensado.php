...
<body>
    ...
    <main>
        ...
        <div class="d-flex justify-content-center mt-4">
            <div class="card w-75">
                <div class="card-body">
                    <h5 class="card-title text-center">Leite Condensado</h5>
                    <h6>Composição</h6>
                    <ul>
                    ...
                    <ul>
                        <li>Pessoas com intolerância à lactose ou alergia ao leite devem evitar.</li>
                        <li>Pessoas com diabetes devem consumir com cautela devido ao alto teor de açúcar.</li>
                    </ul>
                    <audio controls="controls" src="./audios/leite_condensado.mp3" style="width: 260px;"></audio>
                </div>
            </div>
        </div>
    </main>
